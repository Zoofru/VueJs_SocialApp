...
export default {
    ...
    data() {
        return {
            tabs: ["Home", "People", "Photos", "Feed", "Profile", "Settings"]
        }
    },
    methods: {
        signInCheck() {
...
<template>
    <div v-if="signInCheck()" id='tabBox'>
        <div v-for="(item, index) in tabs" :key="index">
            <div id='tab'>
                <div v-if="item == 'Home'" id="tab">
                    <div id='tab-content' @click='this.linkTo("Home")'>
                        <svg id="icons" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                ...
                <div v-else-if="item == 'People'" id='tab'>
                    <div id="tab-content">
                ...
                <div v-else-if="item == 'Photos'" id='tab'>
                    <div id='tab-content'>
                ...
                <div v-else-if="item == 'Settings'" id='tab'>
                            <div id='tab-content' @click='this.linkTo("Settings")'>
